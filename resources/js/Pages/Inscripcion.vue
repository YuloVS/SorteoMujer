<template>
	<FormularioLayout>
		<div class="flex justify-center bg-gray-50 mt-2">
                ...
                <form @submit.prevent="submit">
                    <div class="flex flex-col md:flex-row">
                        ...
                        <div class="flex flex-col mt-3 md:mt-0 md:ml-6">
                            ...
                            <input v-model="form.nombre" id="nombre" type="text" class="px-3 py-2 bg-gray-50 border-2 border-gray-300 rounded-md text-gray-700 focus:border-pink-500 focus:outline-none focus:ring-0">
                        ...
                        <div class="flex flex-col mt-3 md:mt-0 md:ml-6">
                            ...
                            <input v-model="form.apellido" id="apellido" type="text" class="px-3 py-2 bg-gray-50 border-2 border-gray-300 rounded-md text-gray-700 focus:border-pink-500 focus:outline-none focus:ring-0">
                    ...
                    <div class="flex flex-col md:flex-row mt-3 md:mt-6">
                        <div class="flex flex-col">
                            <label class="text-base font-bold text-black">Teléfono</label>
                            <input v-model="form.telefono" id="telefono" type="text" class="px-3 py-2 bg-gray-50 border-2 border-gray-300 rounded-md text-gray-700 focus:border-pink-500 focus:outline-none focus:ring-0">
                        ...
                        <div class="flex flex-col mt-3 md:mt-0 md:ml-6">
                            ...
                            <input v-model="form.direccion" id="direccion" type="text" class="px-3 py-2 bg-gray-50 border-2 border-gray-300 rounded-md text-gray-700 focus:border-pink-500 focus:outline-none focus:ring-0">
                        ...
                        <div class="flex flex-col mt-3 md:mt-0 md:ml-6">
                            ...
                            <input v-model="form.email" id="email" type="text" class="px-3 py-2 bg-gray-50 border-2 border-gray-300 rounded-md text-gray-700 focus:border-pink-500 focus:outline-none focus:ring-0">
